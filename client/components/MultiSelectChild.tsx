...
export function MultiSelectChild({
  options = [],
  value = [],
  onChange,
  placeholder = "Select...",
  ...
  const toggle = (val?: string) => {
    ...
    selectedSet.has(val) ? next.delete(val) : next.add(val);
  ...
  // Recursively collect all topic values
  ...
  // Recursive render for nested subjects → topics
